...
\begin{document}
	...
	\addplot [fill=gray!25] {binom(x,21,0.3)}; 
	\path[name path=B] 
	(axis cs:10.5,\pgfkeysvalueof{/pgfplots/ymin})--
	(axis cs:10.5,\pgfkeysvalueof{/pgfplots/ymax});
          %  \draw (name path=first, axis cs:10.5,\pgfkeysvalueof{/pgfplots/ymin}) -- (axis cs:10.5,\pgfkeysvalueof{/pgfplots/ymax});
          %  \draw (name path =l2, axis cs:20.5,\pgfkeysvalueof{/pgfplots/ymin}) -- (axis cs:20.5,\pgfkeysvalueof{/pgfplots/ymax});
