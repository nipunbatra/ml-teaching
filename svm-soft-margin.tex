	...
	
{
	...
	\includepdf[page=50]{svm/Svm-notes.pdf}
}
...
{
	\setbeamercolor{background canvas}{bg=}
	\includepdf[page=51-58]{svm/Svm-notes.pdf}
}
...
{
	\setbeamercolor{background canvas}{bg=}
	\includepdf[page=59-61]{svm/Svm-notes.pdf}
}
...
{
	\setbeamercolor{background canvas}{bg=}
	\includepdf[page=62]{svm/Svm-notes.pdf}
}
