...
\vspace{-0.4cm}
\begin{align*}
P(y | X, \theta) &= \prod_{i=1}^{n} P(y_{i} | x_{i}, \theta) \\ &= \prod_{i=1}^{n} \Big\{\frac{1}{1 + e^{-x_{i}\theta}}\Big\}^{y_{i}}\Big\{1 - \frac{1}{1 + e^{-x_{i}\theta}}\Big\}^{1 - y_{i}} \\
\end{align*}
\vspace{0.2cm}
...
$f(z_{i})$ refers to \underline{probability} of class \underline{i}
\end{frame}
