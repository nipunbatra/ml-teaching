...
\begin{document}
	...
	\begin{minipage}{0.3\textwidth}
		...
		\begin{figure}
			...
			\includegraphics{notebooks/logistic-orange-tomatoes-original.pdf}
		\end{figure}
	\end{minipage} \\
...
\end{frame}
	...
	\begin{minipage}{0.3\textwidth}
		...
		\begin{figure}
			...
			% From https://i.imgur.com/AyzVOIO.jpg
			\includegraphics{notebooks/logistic-orange-tomatoes.pdf}
		\end{figure}
	\end{minipage} \\
	%\vspace{-1.7cm}
...
\begin{minipage}{0.3\textwidth}
	...
	\begin{figure}
		...
		% From https://i.imgur.com/AyzVOIO.jpg
		\includegraphics{notebooks/linear-orange-tomatoes.pdf}
	\end{figure}
\end{minipage} \\
\begin{equation*}
...
\begin{frame}{Idea: Use Linear Regression}
\includegraphics{notebooks/linear-orange-tomatoes-decision.pdf}
\end{frame}

\begin{frame}{Idea: Use Linear Regression}
\includegraphics{notebooks/linear-orange-tomatoes-decision-modified.pdf}
...
\includegraphics{notebooks/linear-orange-tomatoes-decision-ideal.pdf}
...
\begin{minipage}{0.3\textwidth}
% Show the image at item three and afterwards
\includegraphics{notebooks/logistic.pdf}
\end{minipage} \\
...
\end{equation*}
\includegraphics{notebooks/logistic-function.pdf}
\end{frame}
...
\begin{columns}
	\begin{column}{0.5\textwidth}
		\includegraphics[scale=0.7]{notebooks/logistic-sse-loss-contour.pdf}
	\end{column}
\begin{column}{0.5\textwidth}
	\includegraphics[scale=0.7]{notebooks/logistic-sse-loss-3d.pdf}
\end{column}
\end{columns}
\end{frame}
...
\includegraphics{notebooks/logistic-likelihood.pdf}
\end{frame}
...
\pause First, assume $y_i$ is 0, then if $\hat{y}_i$ is 0, the loss is 0; but, if $\hat{y}_i$ is 1, the loss tends towards infinity!
	...
	\includegraphics[scale=0.7]{notebooks/logistic-cross-cost-0}
...
\includegraphics[scale=0.7]{notebooks/logistic-cross-cost-1}
...
\begin{columns}
	\begin{column}{0.5\textwidth}
		\includegraphics[scale=0.7]{notebooks/logistic-cross-loss-contour.pdf}
	\end{column}
	\begin{column}{0.5\textwidth}
		\includegraphics[scale=0.7]{notebooks/logistic-cross-loss-surface.pdf}
	\end{column}
\end{columns}
\end{frame}
...
\includegraphics{notebooks/logisitic-circular-data.pdf}
...
\begin{frame}{Logistic Regression with feature transformation}
\includegraphics{notebooks/logisitic-linear-prediction.pdf}
...
\begin{frame}{Logistic Regression with feature transformation}
\includegraphics{notebooks/logisitic-circular-prediction.pdf}
...
\pause \includegraphics{notebooks/logisitic-circular-probability.pdf}


\end{frame}

\begin{frame}{Multi-Class Prediction}
\includegraphics{notebooks/logisitic-iris.pdf}
...
\begin{frame}{Multi-Class Prediction}
\includegraphics{notebooks/logisitic-iris-prediction.pdf}
...
\begin{frame}{Multi-Class Prediction}
\includegraphics[scale=0.8]{notebooks/logisitic-iris-prediction.pdf}
\pause \begin{enumerate}
