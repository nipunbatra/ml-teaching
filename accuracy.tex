...
\begin{itemize}
	...
	\item No! Since, the test set is only a sample from all possible inputs.
\end{itemize}
...
\bordermatrix{&\texttt{G.T. Positive}&\texttt{G.T. Negative}\cr
               ...
               \texttt{Pred Negative}&1&98}
$$
\pause $$
\bordermatrix{&\texttt{G.T. Positive}&\texttt{G.T. Negative}\cr
               \texttt{Pred Positive}&\texttt{True Positive}&\texttt{False Positive}\cr
               \texttt{Pred Negative}&\texttt{True Negative}&\texttt{False Negative}}
$$
