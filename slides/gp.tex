...
\begin{document}
	...
	\begin{frame}{1D Gaussian Scatter Plot}
		\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../figures/gp/1d-gp}
	\end{frame}
	
	\begin{frame}{1D Gaussian Histogram}
		\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../figures/../figures/gp/1d-gp-hist}
	\end{frame}
	
	\begin{frame}{Varying 1D Gaussian Variance}
		\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../figures/../figures/gp/1d-gp-kde2}
	\end{frame}
	...
	\begin{frame}{Sampling Bi-variate Gaussian - 1}
		\begin{center}
			\includegraphics[height=\textheight -45pt ,keepaspectratio]{../figures/../figures/gp/2d-gp}\\
	...
	\begin{frame}{Sampling Bi-variate Gaussian - 2}
		\begin{center}
			\includegraphics[height=\textheight -45pt ,keepaspectratio]{../figures/../figures/gp/2d-gp2}\\
	...
	\begin{frame}{Sampling Bi-variate Gaussian - 3}
		\begin{center}
			\includegraphics[height=\textheight -30pt ,keepaspectratio]{../figures/../figures/gp/2d-gp3}\\
	...
	\begin{frame}{Surface Plots Bi-variate Gaussian - 1}
		\begin{center}
			\includegraphics[height=\textheight -10pt ,keepaspectratio]{../figures/../figures/gp/2dgp3d}
		\end{center}
	\end{frame}
	
	\begin{frame}{Surface Plots Sampling Bi-variate Gaussian - 2}
		\begin{center}
			\includegraphics[height=\textheight -10pt ,keepaspectratio]{../figures/gp/2dgp3d2}
		\end{center}
	\end{frame}
	...
	\ifnum\value{iter}<6
		\begin{frame}{Cov = 0.1 | Random State - \theiter}
			\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../figures/gp/0.1/\theiter}\\
	...
	{%
		\begin{frame}{Cov = 0.7 | Random State - \theiter}
			\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../figures/gp/0.7/\theiter}\\
			One can notice, increasing the $\rho$ (or the covariance) between $X_1$ and $X_2$ results in the realizations of $X_1$ and $X_2$ to increasingly move together.
		\end{frame}
	}
	...
	{%
		\begin{frame}{Conditional bi-variate | Cov = 0.1 | Random State - \theiter}
			\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../figures/gp/conditional/0.1/\theiter}\\
	...
	{%
		\begin{frame}{Conditional bi-variate | Cov = 0.7 | Random State - \theiter}
			\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{../figures/gp/conditional/0.7/\theiter}\\
			Notice that upon fixing the first random variable, the variance of the second random variable $X_2$ is a function of the covariance ($\rho$) between the two random variables.
		\end{frame}
	}
	...
	{%
		\begin{frame}{Multivariate Gaussian Sample | Random State - \theiter}
			\begin{center}
				\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/5d/\theiter}
			\end{center}
	...
	{%
		\begin{frame}{Conditional Multivariate Distribution | Random State - \theiter}
			\begin{center}
				\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/5d/conditional/1/\theiter}
			\end{center}
			From the visualisation above we can see that:
			\begin{itemize}
	...
	\begin{frame}{20 Dimensional Multivariate}
		\begin{center}
			\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/20d}\\
		\end{center}	
	...
	{%
		\begin{frame}{Multivariate (20D) Distribution Samples | Random State - \theiter}
			\begin{center}
				\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/20d/\theiter}
			\end{center}
	...
	\begin{frame}{Updated Covariance Matrix}
		\begin{center}
			\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/post20d}
		\end{center}
	...
	{%
		\begin{frame}{Conditional Multivariate (20D) Distribution Samples | Random State - \theiter}
			\begin{center}
				\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/20d/conditional/\theiter}
			\end{center}
	...
	\begin{frame}{Multivariate (20D) Posterior}
		\begin{center}
			\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/20dcov} \\
		\end{center}
	...
	\begin{frame}{Varying $l$ with $\sigma = 1$}
		\begin{center}
			\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/vary_l}\\
	...
	\begin{frame}{Varying $\sigma$ with $l = 0.1$}
		\begin{center}
			\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/vary_s}\\
	...
	\begin{frame}{Varying kernel parameters on 20D Guassian with conditioning}
		\begin{center}
			\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/kernel/20gp_ker1}\\
	...
	\begin{frame}{Varying kernel parameters on 20D Guassian with conditioning}
		\begin{center}
			\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/kernel/20gp_ker2}\\
	...
	\begin{frame}{Varying kernel parameters on 20D Guassian with conditioning}
		\begin{center}
			\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/kernel/20gp_ker3}\\
	...
	\begin{frame}{Varying kernel parameters on 20D Guassian with conditioning}
		\begin{center}
			\includegraphics[width=\linewidth, height=\textheight -120pt ,keepaspectratio]{../figures/gp/kernel/20gp_ker4}\\
...
\begin{frame}{GPs}
	\includegraphics[width=.5\textwidth]{../figures/gp/final/noisygp}%
	\includegraphics[width=.5\textwidth]{../figures/gp/final/noiselessgp}
