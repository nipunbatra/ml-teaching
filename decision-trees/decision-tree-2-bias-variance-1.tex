...
\begin{center}
\includegraphics[scale=0.5]{imgs/dataset}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.5]{imgs/depth-0-boundary}	
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[scale=1]{imgs/depth-1-decision-tree}	
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.5]{imgs/depth-1-tree}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.65]{imgs/depth-2-decision-tree}	
\end{center}
\end{frame}
...
The Decision Boundary
\begin{center}
\includegraphics[scale=0.5]{imgs/depth-2-tree}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.5]{imgs/sine-dataset}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.5]{imgs/sine-depth-1-decision-tree}
\end{center}
\end{frame}
...
Decision Boundary
\begin{center}
\includegraphics[scale=0.5]{imgs/sine-depth-1-tree}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.5]{imgs/sine-no-depth-tree}
\end{center}
\end{frame}
...
\begin{figure}
	\centering
	\includegraphics[scale=0.55]{../bias-variance/imgs/dataset-1}
\end{figure}
...
\begin{figure}%
\centering
\subfloat[Decision Boundary]{{\includegraphics[width=0.45\textwidth]{../bias-variance/imgs/example-1-depth-1-boundary} }}%
\qquad
\subfloat[Decision Tree]{{\includegraphics[width =0.45\textwidth]{../bias-variance/imgs/example-1-depth-1-decision-tree} }}%
\label{fig:example}%
\end{figure}
\end{frame}
...
\begin{figure}%
\centering
\subfloat[Decision Boundary]{{\includegraphics[width=0.45\textwidth]{../bias-variance/imgs/example-1-nolimit-boundary} }}%
\qquad
\subfloat[Decision Tree]{{\includegraphics[width =0.45\textwidth]{../bias-variance/imgs/example-1-nolimit-decision-tree} }}%
\label{fig:example}%
\end{figure}
\end{frame}
...
\begin{figure}%
\centering
\subfloat[Train Set]{{\includegraphics[width=0.45\textwidth]{../bias-variance/imgs/dataset-2-train} }}%
\qquad
\subfloat[Test Set]{{\includegraphics[width =0.45\textwidth]{../bias-variance/imgs/dataset-2-test} }}%
\label{fig:example}%
\end{figure}
\end{frame}
...
\begin{figure}%
\centering
\subfloat[Decision Boundary]{{\includegraphics[width=0.45\textwidth]{../bias-variance/imgs/example-2-depth-1-boundary} }}%
\qquad
\subfloat[Decision Tree]{{\includegraphics[width =0.45\textwidth]{../bias-variance/imgs/example-2-depth-1-decision-tree} }}%
\label{fig:example}%
\end{figure}
\end{frame}
...
\begin{center}
\includegraphics[scale=0.5]{../bias-variance/imgs/example-2-nolimit-boundary}
\end{center}
\end{frame}
